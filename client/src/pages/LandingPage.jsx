...
export default function LandingPage() {
  return(
    <>
      ...
      <section id="features" className="features bg-primary px-[20vw] text-white py-30">
      ...
      <section id="how-to-use" className="bg-neutral-white pt-30 px-[20vw]">
      ...
      <div className="footer bg-neutral-gray text-white text-center pt-30 pb-5 px-[20vw]">
        ...
        <ul className="flex gap-4 justify-center">
          <li className="basis-1/10"><button className="cursor-pointer" onClick={() => animateScroll.scrollToTop({ duration: 500, smooth: true })}>Home</button></li>
          <li className="border border-gray-500"></li>
          <li className="basis-1/10 cursor-pointer"><ScrollLink to="how-to-use" smooth={true} duration={500}>How to use?</ScrollLink></li>
          <li className="border border-gray-500"></li>
          <li className="basis-1/10 cursor-pointer"><ScrollLink to="features" smooth={true} duration={500}>Features</ScrollLink></li>
        </ul>
      </div>
